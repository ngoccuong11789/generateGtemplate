      ...
      decoration: ShapeDecoration(
        image: DecorationImage(
          image: widget.product.avatar != null
              ? CachedNetworkImageProvider(getImageUrl(widget.product.avatar!.id!,type: ImageType.thumbnail))
              : Image.asset('assets/fallback.jpg', package: packageName).image,
          fit: BoxFit.fill,
        ),
        ...
        Text(
          widget.product.quantity != null
              ? SharedLocalizations.of(context)!
                  .compact(widget.product.quantity!)
              : "0",
          style: const TextStyle(
            color: Color(0xFF344053),
            fontSize: 12,
          ...
          child: Row(
            ...
            children: [
              ...
              CommonSquareCheckBox(
                value: state.selectedProduct.contains(widget.product),
                onChanged: (value) {
                  if (!value!) {
                    context
                        .read<VoucherProductBloc>()
                        .add(UnSelectProduct(widget.product));
                  } else {
                    context
                        .read<VoucherProductBloc>()
