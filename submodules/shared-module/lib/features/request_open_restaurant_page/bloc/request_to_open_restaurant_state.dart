...
class RequestToOpenRestaurantState extends Equatable {
  ...
  const RequestToOpenRestaurantState({
      this.listCountries,
  ...
  RequestToOpenRestaurantState copyWith({
    ...
    return RequestToOpenRestaurantState(
