...
class RequestToOpenRestaurant extends StatelessWidget {
  const RequestToOpenRestaurant({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
        create: (context) => RequestToOpenRestaurantBloc(),
...
class StartScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: MainAppBar(
        titleAppbar: SharedLocalizations.of(context)!.requestOpenRestaurant,
      ),
      body: Container(
          ...
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) => BlocProvider.value(
                value: RequestToOpenRestaurantBloc(),
                child: FormScreen(),
              ),
            ),
          );
