...
class ItemShopVouchers extends StatelessWidget {
  final DataItemShopVoucher dataItemVoucher;
  final num price;
  final VoidCallback? onData;
  const ItemShopVouchers(
      {super.key,
  ...
  Widget build(BuildContext context) {
    ...
    num calculatorPriceVoucher(DataItemShopVoucher data,) {
    ...
    var leftVoucher = Row(
      children: [
        Expanded(
            flex: 8,
            child: package.createSvgFromAsset("assets/icons/shop-voucher.svg",
    ...
    return BlocBuilder<ShopVoucherBloc, ShopVoucherState>(
      ...
      final check = (state.listItemVoucher ?? [])
          .where((element) =>
            ...
            children: [
              Opacity(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    border: Border.all(color: Color(0xFFFF9B65), width: 1),
...
Widget contentCoupon(DataItemShopVoucher data, BuildContext context) {
