...
part 'data_open_shop_response.g.dart';

@JsonSerializable(
  fieldRename: FieldRename.snake,
  explicitToJson: true,
)
class DataOpenShopResponse extends Equatable {
  final String? id;
  ...
  DataOpenShopResponse(
      ...
      this.attachments,
      this.isOfflineStore);
  factory DataOpenShopResponse.fromJson(Map<String, dynamic> json) {
    return _$DataOpenShopResponseFromJson(json);
  }

  Map<String, dynamic> toJson() {
    return _$DataOpenShopResponseToJson(this);
  }
