...
import '../bloc/update_restaurant_bloc.dart';
...
class _InputCategoryState extends State<InputCategory> {
  ...
  void initState() {
    ...
    BlocProvider.of<UpdateRestaurantBloc>(context).add(const HandleGetListCategory());
    super.initState();
  }
        ...
        GestureDetector(
          onTap: () {
            showModalBottomSheet(
              ...
              context: context,
              builder: (context) => BlocBuilder<UpdateRestaurantBloc,
                              ...
                              return Row(
                                children: [
                                  ...
                                  Checkbox(
                                    ...
                                    onChanged: (newValue) {
                                      updateRestaurantBloc.add(ChangeCategory(index: index));
                                    },
                                  ),
                                  GestureDetector(
                                    onTap: () {
          ...
          child: Container(
            ...
            child: BlocBuilder<UpdateRestaurantBloc,
                UpdateRestaurantState>(
              bloc: updateRestaurantBloc,
              builder: (context, state) {
                List<Category> listChooseCategory = updateRestaurantBloc.getChosenCategory();
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  GestureDetector(
                                    onTap: () => updateRestaurantBloc.add(DeleteCategory(category: value)),
